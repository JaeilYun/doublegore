		...
		<div class="main-content" style="padding-top: 20px;">
			...
			<div class="widget widget-quick-note quick-note-create">
				...
				<div class="widget-footer">
					<div class="btn-group">
						<button type="button" class=" btn btn-clean note-view-menu-btn" style="text-decoration:none !important;color: #bbb;font-weight: 600;">사진</button>
					</div>
					<div class="btn-group" style="float: right;">
						<button type="button" class=" btn btn-clean note-view-delete-btn" style="text-decoration:none !important;color: rgba(219, 56, 51, 0.5);font-weight: 600;">초기화</button>
						<button type="button" class=" btn btn-clean note-view-edit-btn" style="text-decoration:none !important;color: rgba(75, 168, 75, 0.5);font-weight: 600;">저장</button>
					</div>
				</div>
			</div>
			</div>
			...
			<div class="project-section activity">
				...
				<ul class="list-unstyled activity-list">
					...
					<li data-toggle="collapse" data-parent="#accordion2" href="#collapseOne3">
						<i class="fa fa-unlock activity-icon pull-left icon-danger"></i>
						<div>
							<p>You have unsecure file permission on this project. Go to <a href="page-file-manager.html">File Manager</a> to fix it <span class="timestamp">3 hours ago</span></p>
